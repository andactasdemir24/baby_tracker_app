        ...
        builder: (context) {
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (!displayedTypes.contains(type)) {
                ...
                header = Padding(
                  ...
                  child: Align(
                    ...
                    child: Text(
                      type,
                      style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: mainIconColor),
                    ),
                  ),
                );
              }
              return Column(
                children: [
                  header,
                  _buildItem(context, all, allviewmodel), // Öğeyi oluşturmak için yardımcı metod
                ],
              );
            },
          );
